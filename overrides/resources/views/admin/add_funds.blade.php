...
.yd-manual-payment-form{display:flex;flex-direction:column;align-items:center;gap:14px;margin-top:20px;width:100%}
.yd-deposit-form-card{box-sizing:border-box;width:min(100%,680px);max-width:680px;margin:0 auto;padding:24px 26px;border:1px solid #e4e7ec;border-radius:16px;background:#fff;box-shadow:0 12px 32px rgba(23,25,31,.07)}
...
.yd-manual-fields{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}
...
.yd-form-field input{box-sizing:border-box;width:100%;height:56px;padding:0 15px;border:1px solid #dfe3ea;border-radius:10px;background:#fbfcfd;color:#17191f;font:inherit;font-size:15px;font-weight:800;text-align:right}
...
.yd-credit-preview{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:14px;padding:12px 14px;border-radius:10px;background:#f6f7f9;border:1px solid #e7e9ee}.yd-credit-preview span{color:#68707e;font-size:12px;font-weight:800}.yd-credit-preview strong{font-size:16px;color:#17191f}
.yd-proof-field{display:grid;gap:8px;margin:18px 0 0}.yd-proof-upload{position:relative;display:grid;grid-template-columns:46px minmax(0,1fr) 74px;align-items:center;gap:12px;min-height:98px;padding:15px 16px;border:1.5px dashed #ccd2db;border-radius:12px;background:#fafbfc;overflow:hidden;cursor:pointer}.yd-proof-upload:hover,.yd-proof-upload:focus-within{border-color:#e4b500;background:#fffdf5;box-shadow:0 0 0 3px rgba(247,197,30,.10)}
...
.yd-review-strip{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:16px}.yd-review-strip span{display:flex;align-items:center;justify-content:center;min-height:40px;padding:7px 9px;border-radius:9px;background:#f7f8fa;color:#555d68;font-size:11px;font-weight:850;text-align:center}
.yd-submit-deposit{display:grid;place-items:center;gap:2px;box-sizing:border-box;width:min(100%,680px);max-width:680px;min-height:60px;margin:0 auto;padding:10px 16px;border:0;border-radius:12px;background:#f7c51e;color:#17191f;cursor:pointer;box-shadow:0 10px 22px rgba(247,197,30,.2)}.yd-submit-deposit span{font-size:15px;font-weight:950}.yd-submit-deposit small{font-size:10px;font-weight:800;opacity:.72}.yd-submit-deposit:hover{transform:translateY(-1px);box-shadow:0 14px 28px rgba(247,197,30,.28)}.yd-submit-deposit:disabled{opacity:.65;cursor:wait;transform:none}
.yd-instapay-destination{margin-top:12px}
@media(max-width:767px){.yd-deposit-form-card{width:100%;max-width:none;padding:16px}.yd-submit-deposit{width:100%;max-width:none}.yd-deposit-form-title{align-items:flex-start}.yd-manual-fields{grid-template-columns:1fr}.yd-review-strip{grid-template-columns:1fr}.yd-proof-upload{grid-template-columns:42px minmax(0,1fr)}.yd-proof-preview{grid-column:1/-1;width:100%;height:150px}.yd-deposit-form-title>span{display:none}}
</style>
@endsection
